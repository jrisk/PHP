...
if (!$result) echo "Delete failed: $query" . $connection->error . "<br><br>";
...
if (!$result) echo "INSERT failed: $query" . $connection->error . "<br><br>";
}
...
if (!$result) die("Database connection failed" . $connection->error);
